...
function button1() {
    ...
    document.getElementById("buttonsImg").innerHTML=" <figure> <a href='../creditsMarine/creditsMarine.html#button1img'> <img style='max-width: 100%;' index-src='index-src/immortalJellyfish.png' alt='immortal jellyfish'/></a><figcaption>Turritopsis dohrnii (immortal jellyfish)</figcaption> </figure>";
}
...
function button2() {
    ...
    document.getElementById("buttonsImg").innerHTML="<figure> <a href='../creditsMarine/creditsMarine.html#button2img'>  <img style='max-width: 100%;' index-src='index-src/crossSection.png' alt='cross section of jellyfish'/></a><figcaption>Jellyfish anatomy</figcaption> </figure>";
}
...
function button3() {
    ...
    document.getElementById("buttonsImg").innerHTML="<figure> <a href='../creditsMarine/creditsMarine.html#button3img'> <img style='max-width: 100%;' index-src='index-src/glowingJelly.png' alt='glowing jellyfish'/></a><figcaption>Lion’s mane jellyfish in the White Sea</figcaption> </figure>";
}
...
function button4() {
    ...
    document.getElementById("buttonsImg").innerHTML="<figure> <a href='../creditsMarine/creditsMarine.html#button4img'> <img style='max-width: 100%;' index-src='index-src/deepstaria.gif' alt='Deepstaria jellyfish'/></a><figcaption>A Deepstaria (Instagram censors some deepstaria images due to its candidly graphic appearance)</figcaption> </figure>";
}
...
function button5() {
    ...
    document.getElementById("buttonsImg").innerHTML="<figure> <a href='../creditsMarine/creditsMarine.html#button5img'> <img style='max-width: 100%;' index-src='index-src/lionsmane.jpeg' alt='Lions Mane jellyfish'/></a><figcaption>Size comparison next to an average human male</figcaption> </figure>";
}
